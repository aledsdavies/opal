...
// formatStep formats a single execution step with tree-like visualization
func (ep *ExecutionPlan) formatStep(step ExecutionStep, indent int, stepNum int) string {
	return ep.formatStepWithTree(step, "", true, stepNum)
}
